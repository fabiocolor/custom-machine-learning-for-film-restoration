...
- **Sequence-level successful**: Correlative shots with consistent lighting/style and good reference quality (e.g., Friends, Mission Kill continuous sequences)
- **Scene-level separation needed**: Even correlative sequences with varying visual characteristics or damaged reference material (e.g., Frontier Experience - acceptable but suboptimal results)
