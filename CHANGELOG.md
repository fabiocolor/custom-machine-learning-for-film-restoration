...
### Added
- Case studies page (`docs/case-studies.md`) covering five films: Candy Candy, Friends, Rebelion de las Tapadas, Mission Kill, and El Gran Tinterillo.
- IMAGE_CATALOG.md with descriptions for all image assets.
